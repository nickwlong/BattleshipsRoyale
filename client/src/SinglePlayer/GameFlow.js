    ...
    <row>
      <column>
        ...
        <div className="player2 board" id="GameContainer2">
          {props.play2Grid.map(
            (square, index) => (<SquareOpponent checkGameWinner={checkGameWinner} square={square} key={`player2Board_${index}`} index={index} gridArray={props.play2Grid} setGridArray={props.setPlay2Grid} setTurnState={setTurnState} turnState={turnState}/>)            )}
        </div>
      </column>
      <column>
        ...
        <div className="player2 board" id="GameContainer2">
          {props.play3Grid.map(
            (square, index) => (<SquareOpponent checkGameWinner={checkGameWinner} square={square} key={`player2Board_${index}`} index={index} gridArray={props.play3Grid} setGridArray={props.setPlay3Grid} setTurnState={setTurnState} turnState={turnState}/>)
            )}
        </div>
      </column>
    </row>
    <row>
      <column>
        ...
        <div className="player2 board" id="GameContainer2">
          ...
          (square, index) => (<Square checkGameWinner={checkGameWinner} square={square} key={`player1Board_${index}`} index={index} play1Grid={props.play1Grid} setPlay1Grid={props.setPlay1Grid} setTurnState={setTurnState} turnState={turnState}/>) // these 'tags' of square and index pass into the 'props' within the Square class component
            )}
        </div>
      </column>
    </row>
