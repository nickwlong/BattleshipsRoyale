...
export function GameFlow(props) {
  ...
  async function checkGameWinner() {
    ...
    if(countship2 === 2){
      ...
      const wait = await props.setPlay1Grid(newplay1Grid)
    }
    ...
    var countship2 = props.play2Grid.filter((obj) => (obj.shipStatus === "ship2C" || obj.shipStatus === "ship2") && obj.hitStatus === "hit").length;
    if(countship2 === 2){
      ...
      const wait = await props.setPlay2Grid(newplay2Grid)
    }
    var countship31 = props.play2Grid.filter((obj) => (obj.shipStatus === "ship31C" || obj.shipStatus === "ship31") && obj.hitStatus === "hit").length;
    if(countship31 === 3){
    ...
    var countship32 = props.play2Grid.filter((obj) => (obj.shipStatus === "ship32C" || obj.shipStatus === "ship32") && obj.hitStatus === "hit").length;
    if(countship32 === 3){
    ...
    var countship4 = props.play2Grid.filter((obj) => (obj.shipStatus === "ship4C" || obj.shipStatus === "ship4") && obj.hitStatus === "hit").length;
    if(countship4 === 4){
    ...
    var countship5 = props.play2Grid.filter((obj) => (obj.shipStatus === "ship5C" || obj.shipStatus === "ship5") && obj.hitStatus === "hit").length;
    if(countship5 === 5){
    ...
    var countship2 = props.play3Grid.filter((obj) => (obj.shipStatus === "ship2C" || obj.shipStatus === "ship2") && obj.hitStatus === "hit").length;
    if(countship2 === 2){
      ...
      const wait = await props.setPlay3Grid(newplay3Grid)
    }
    var countship31 = props.play3Grid.filter((obj) => (obj.shipStatus === "ship31C" || obj.shipStatus === "ship31") && obj.hitStatus === "hit").length;
    if(countship31 === 3){
    ...
    var countship32 = props.play3Grid.filter((obj) => (obj.shipStatus === "ship32C" || obj.shipStatus === "ship32") && obj.hitStatus === "hit").length;
    if(countship32 === 3){
    ...
    var countship4 = props.play3Grid.filter((obj) => (obj.shipStatus === "ship4C" || obj.shipStatus === "ship4") && obj.hitStatus === "hit").length;
    if(countship4 === 4){
    ...
    var countship5 = props.play3Grid.filter((obj) => (obj.shipStatus === "ship5C" || obj.shipStatus === "ship5") && obj.hitStatus === "hit").length;
    if(countship5 === 5){
